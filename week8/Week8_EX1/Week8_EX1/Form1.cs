...
namespace Week8_EX1
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeGraphics()
        {
            ...
            r1 = new EditableRectangle(b.Width / 3 + 100, pictureBox1.Bottom / 3, b.Width / 4, b.Height / 2, pictureBox1, this);
            PenTrajectory = new Pen(Color.Black, 1);
        }
        ...
        private void drawPoints()
        {
            ...
            {
                Rectangle rect = new Rectangle(dp.X - 1, dp.Y - 1, 4, 4);
        ...
        private void trackBar1_Scroll(object sender, EventArgs e)
        {
            ...
            label1.Text = "Points - " + pointnumber.ToString();
        }
